...
public class Prospector : MonoBehaviour
{
    ...
    void UpdateDrawPile()
    {
        ...
        for (int i = 0; i < drawPile.Count; i++)
        {
            ...
            cd.transform.localPosition = new Vector3(layout.multiplier.x * (layout.drawPile.x + (i * dpStagger.x)), layout.multiplier.y * (layout.drawPile.y + (i * dpStagger.y)), -layout.discardPile.layerID + (0.1f * i));
            cd.faceUp = false;
    ...
    void ReloadLevel()
    {
        EditorSceneManager.LoadScene("__Prospector_Scene_0");
    }
